...
sample_models = sample_models.sort_values(
    by=["topic", "chunk", "min_df", "max_df", "diy_gram", "tribigram", "stem"]
)
sample_models.to_csv(start.DATA_DIR + "clean/sample_models_update.csv", index=False)
