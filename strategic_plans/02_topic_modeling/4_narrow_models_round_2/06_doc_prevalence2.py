...
for folder in folders:
    df = pd.read_csv(start.DATA_DIR + "narrow_models_round_2/topic_models/" + folder + "/doc_topics.csv")
...
final_df.to_csv(start.DATA_DIR + "narrow_models_round_2/sample_doc_topic_prevalence.csv", index=False)
# %%
