...
for topic_code in ordered_topics:
    ...
    formula = f"{topic_id} ~ C(demographic_quartile) + C(state) + improvement_plan + form_plan"
...
# %%
# Save Excel results
output_path = start.RESULTS_DIR + 'Table8b_demographic_quartiles_coefficients.xlsx'
wb.save(output_path)
