...
# Exclude any codes with "student_subgroups" in the name
codes_to_exclude = [col for col in codes if "student_subgroups" in col]
...
for missing in missing_titles:  # Show all missing titles
    print(f"  {missing}")
